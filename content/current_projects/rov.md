+++
date = '2025-11-03T00:21:04-05:00'
draft = false
title = 'Purdue ROV (Remotely Operated Underwater Vehicle)'
weight = 1
+++

This semester I joined the Purdue ROV team. This student-led team builds an underwater robot that performs tasks to protect the ocean's ecosystem. These tasks are stuipulated by the MATE ROV competition, a yearly World Championship that we take part in over the summer. 
...
The lid prevents electronics from contacting water and has all the team members names embossed onto it. 

The plate has scaffolding to hold the electronic stack and holes for binders. 

{{< img src="rov/Lid1-rov.png" alt="Sketch" width="70%">}}
...
#### Enclosure Lid 
The lid will be resin printed out of Formlabs Clear Resin V5. This year, we decided to switch the material from Aluminum (like the plate), and so I have been spending most of my time working on this. This change was made because it will make it more lightweight, aesthetic and make it easier to monitor leaks. 

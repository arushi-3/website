...
- Hammer Head 
    1. Stamp "Purdue Pete" to the aluminum hex block using the hydraulic press 
    2. Drill and tap a 1/2"-13 threaded hole 
    3. Mill the angle block to mill the wedge feature 
    4. Buff and polish the piece 
- Handle 
    1. Face both ends of the round stock on the lathe 
    2. On the lathe perform operations for 
        - Turning 
        - Threading
        - Parting 
        - Knurling
...
{{< img src="me264/hammer.jpeg" alt="Sketch" width="55%">}}
...
{{< img src="me264/nameplate.jpeg" alt="Sketch" width="60%">}}
...
{{< img src="me264/clock.jpeg" alt="Sketch" width="60%">}}
...
{{< img src="me264/functionaldecom.png" alt="Sketch" width="75%">}}
...
{{< img src="me264/hand sketch.png" alt="Sketch" width="75%">}}

I also created a CAD, Bill of Materials (BOM), and Engineering drawings for all parts as per ASME Y14.5.

{{< img src="me264/cad.png" alt="Sketch" width="90%">}}

#### Features 

1. A sticky note holder that resembles the Boilermaker Special (our campus train)
2. Train tracks on the base that allow for modular mounting of the train and its carts
3. A clear clock enclosure that allows the user to still access the front face of the clock and any buttons 
4. Space underneath the base to store papers 
5. Holes in the base to mount the hammer and the nameplate 

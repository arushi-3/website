...
As a part of Purdue EPICS, a service-learning engineering projection, my team and I built a shape-sorting game for the riders at Agape therapeutic riding. 
...
We got feedback from experts in the field, and adjusted the design to make the front panel removable. This would allow us to provide our community partner with new panel designs over the years, and make it easier for the user to take the pieces out. We made another prototype to reflect these new ideas. The panels would be laser cut on acrylic. 
...
When we received the PLA printed parts, we quickly realized that they were not strong enough to handle drops from high heights, and it would take a lot of time and filament to manufacture 30 pieces. So, after a few decision matrixes and conversations, we decided to use the CNC wood mill to make the pieces. 

{{< img src="files/3Dprint-mailbox.png" alt="Sketch" width="40%">}}
{{< img src="files/Pegs2-mailbox.jpeg" alt="Sketch" width="60%">}}

We ordered all the materials, and started construction of 5 mailboxes. We used the table saw to cut the long wood into size, router for the channels, the drill press, drill gun for holes and impact driver for fastening.  
...
{{< img src="files/Final5-mailbox.jpeg" alt="Sketch" width="60%">}}

Although I'm no longer a part of Purdue EPICS, this project, which spanned my freshman year in college, taught me a lot about research, collaboration, and community service. And as design lead, I enjoyed leading the design process by ensuring the team stays aligned with project timelines and design goals.
